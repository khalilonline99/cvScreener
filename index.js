...
fastify.post("/upload", async (req, res) => {
  ...
  try {
    ...
    //     }
        ...
        const jsonFilePath = path.join(outputFolder, path.basename(data.filename, path.extname(data.filename)), "auto", expectedJsonFileName);
        ...
        if (fs.existsSync(jsonFilePath)) {
          ...
          return res.send({ message: "File processed successfully!", extractedData });
        } else {
          return res
            .code(500)
